...
- BRStudio has been tested under [Kubuntu 22.04 LTS](https://kubuntu.org/) and linux systems based on Ubuntu 22.04 LTS. To set up the environment, simply execute the ```install.sh``` from the [setup](https://github.com/chenh19/BRStudio/tree/master/setup) folder.
